...
myrepl=2
cd ~/Dropbox/LDLD/scripts
gcc LDLD_filter8.c -o filterbyfreq_multi.out -lgmp -lm
myannotation="introns"
#myannotation="intergenic"
#myannotation="coding.exons"
myannotation_ref="coding.exons"
destination_folder=/mnt/scratch/fabrizio/LDLD/above95/${myannotation}.1000g/repl${myrepl}
mkdir $destination_folder
cd /mnt/scratch/fabrizio/LDLD/above95/preparation_coding1000g
mkdir ${destination_folder}/min1
mkdir ${destination_folder}/min5
for myfreq in 1 5; do
for MYCHROM in `seq 1 22`; do
#echo $MYCHROM
NLINES=$( zcat /mnt/scratch/fabrizio/LDLD/above95/${myannotation_ref}.1000g/repl1/min${myfreq}/chr${MYCHROM}.min${myfreq}.vcf.gz | grep -v '#' | wc -l )
NLINES_TARGET=$(( 15 * $NLINES ))
echo $NLINES
#STRANGE LINES THAT USED TO BE NECESSARY TO FIX PROBLEM IN HEADER AFTER REORDERING. SOLVE THAT PROBLEM AND REMOVE THIS
#BEGINVCF=$( zcat ${myannotation}/chr${MYCHROM}.dest.vcf.gz | head -1 )
#zcat ${myannotation}/chr${MYCHROM}.dest.vcf.gz | head -500 | grep '##' | awk -v mystop=$BEGINVCF 'BEGIN{COUNTER=0}{if ($1==mystop){COUNTER=COUNTER+1}; if (COUNTER<2){print}}' > ${myannotation}/chr${MYCHROM}.dest.vcf
#zcat ${myannotation}/chr${MYCHROM}.dest.vcf.gz | head -500 | grep -v '##' | grep '#CHROM' | tail -1 >> ${myannotation}/chr${MYCHROM}.dest.vcf
#zcat ${myannotation}/chr${MYCHROM}.dest.vcf.gz | grep -v '#' >> ${myannotation}/chr${MYCHROM}.dest.vcf
#gzip -f ${myannotation}/chr${MYCHROM}.dest.vcf
bcftools view -q 0.001:minor ${myannotation}/chr${MYCHROM}.dest.vcf.gz > ${myannotation}/chr${MYCHROM}.tab
NLINES_TAB=$( cat ${myannotation}/chr${MYCHROM}.tab | wc -l )
echo 'step1'
echo "NLINES TAB $NLINES_TAB"
if [ $myannotation != $myannotation_ref ];then
    echo "subsample 1"
    cat ${myannotation}/chr${MYCHROM}.tab | head -300 | grep '#'  > ${myannotation}/chr${MYCHROM}.tab2
    shuf -n $NLINES_TARGET <( cat ${myannotation}/chr${MYCHROM}.tab | grep -v '#' ) | sort -Vu -k1,1 -k2,2 >> ${myannotation}/chr${MYCHROM}.tab2
    mv ${myannotation}/chr${MYCHROM}.tab2 ${myannotation}/chr${MYCHROM}.tab
fi
cp ~/Dropbox/LDLD/scripts/filterbyfreq_multi.out . 
cp ~/Dropbox/LDLD/scripts/nspops.txt .
echo 'step2'
MYVCF=${destination_folder}/min${myfreq}/chr${MYCHROM}.min${myfreq}.vcf
./filterbyfreq_multi.out ${myannotation}/chr${MYCHROM}.tab nspops.txt 0.0${myfreq} 12 0 | grep -v 'Reading\|number of samples\|nsamples in pop' | gzip -f > ${MYVCF}.temp.gz
if [ $myannotation != $myannotation_ref ];then
    cat ${myannotation}/chr${MYCHROM}.tab | head -300 | grep '#' > ${MYVCF}
    shuf -n $NLINES <( zcat ${MYVCF}.temp.gz | grep -v '#' ) | sort -Vu -k1,1 -k2,2 >> ${MYVCF}
else 
    cat ${myannotation}/chr${MYCHROM}.tab | head -300 | grep '#' > ${MYVCF}
    zcat ${MYVCF}.temp.gz >> ${MYVCF}
fi
gzip -f ${MYVCF}
done;done
...
#myannotation="coding.exons"
myannotation_ref="coding.exons"
for myrepl in 2 5; do
echo 'myrepl is ' $myrepl
destination_folder=/mnt/scratch/fabrizio/LDLD/above95/${myannotation}.1000g/repl${myrepl}
mkdir $destination_folder
for myfreq in 1 5; do
mkdir ${destination_folder}/min${myfreq}
for MYCHROM in `seq 1 22`; do
echo $MYCHROM
MYVCF=${destination_folder}/min${myfreq}/chr${MYCHROM}.min${myfreq}.vcf
NLINES=$( zcat /mnt/scratch/fabrizio/LDLD/above95/${myannotation_ref}.1000g/repl1/min${myfreq}/chr${MYCHROM}.min${myfreq}.vcf.gz | grep -v '#' | wc -l )
bcftools view -q 0.001:minor ${myannotation}/chr${MYCHROM}.dest.vcf.gz > ${myannotation}/chr${MYCHROM}.tab
./filterbyfreq_multi.out ${myannotation}/chr${MYCHROM}.tab nspops.txt 0.0${myfreq} 12 0 | grep -v 'Reading\|number of samples\|nsamples in pop' | gzip -f > ${MYVCF}.temp.gz
NLINES_SOURCE=$( zcat ${MYVCF}.temp.gz |wc -l )
MYPROB=$( awk -v var1=$NLINES -v var2=$NLINES_SOURCE 'BEGIN{print var2/var1}' )
cat ${myannotation}/chr${MYCHROM}.tab | grep '#' > $DESTINATIONFILE
zcat ${MYVCF}.temp.gz | awk -v MYPROB=$MYPROB '{if (rand()<MYPROB){print}}' >> ${MYVCF}
gzip -f ${MYVCF}
rm ${MYVCF}.temp.gz
done;done;done
...
if [ $myannotation != $myannotation_ref ];then
    cat ${myannotation}/chr${MYCHROM}.tab | head -300 | grep '#' > ${MYVCF}
    shuf -n $NLINES <( zcat ${MYVCF}.temp.gz | grep -v '#' ) | sort -Vu -k1,1 -k2,2n >> ${MYVCF}
else 
    cat ${myannotation}/chr${MYCHROM}.tab | head -300 | grep '#' > ${MYVCF}
    zcat ${MYVCF}.temp.gz >> ${MYVCF}
fi
...
myannotation="coding.exons"
myannotation="introns"
destination_folder=/mnt/scratch/fabrizio/LDLD/above95/${myannotation}.1000g/repl1
cd /mnt/scratch/fabrizio/LDLD/above95/preparation_coding1000g
mkdir ${destination_folder}/min1
mkdir ${destination_folder}/min5
for reschr in 1 2; do
mkdir ${destination_folder}/min1/reschr${reschr}/
mkdir ${destination_folder}/min5/reschr${reschr}/
cp ~/Dropbox/LDLD/scripts/filterbyfreq_multi.out . 
cp ~/Dropbox/LDLD/scripts/nspops.txt .
done
for MYCHROM in `seq 1 22`; do
echo $MYCHROM
bcftools view -q 0.001:minor ${myannotation}/chr${MYCHROM}.dest.vcf.gz > ${myannotation}/chr${MYCHROM}.tab
./filterbyfreq_multi.out ${myannotation}/chr${MYCHROM}.tab nspops.txt 0.05 12 | grep -v 'Reading\|number of samples\|nsamples in pop' | gzip -f > ${destination_folder}/min5/chr${MYCHROM}.min5.vcf.gz
./filterbyfreq_multi.out ${myannotation}/chr${MYCHROM}.tab nspops.txt 0.01 12 | grep -v 'Reading\|number of samples\|nsamples in pop' | gzip -f > ${destination_folder}/min1/chr${MYCHROM}.min1.vcf.gz
for reschr in 1 1; do
bcftools view -q 0.001:minor ${myannotation}/reschr${reschr}/chr${MYCHROM}.dest.vcf.gz  > ${myannotation}/reschr${reschr}/chr${MYCHROM}.tab
cp ~/Dropbox/LDLD/scripts/filterbyfreq_multi.out . 
cp ~/Dropbox/LDLD/scripts/nspops.txt .
./filterbyfreq_multi.out ${myannotation}/reschr${reschr}/chr${MYCHROM}.tab nspops.txt 0.05 12 | grep -v 'Reading\|number of samples\|nsamples in pop' | gzip -f > ${destination_folder}/min5/reschr${reschr}/chr${MYCHROM}.min5.vcf.gz
./filterbyfreq_multi.out ${myannotation}/reschr${reschr}/chr${MYCHROM}.tab nspops.txt 0.01 12 | grep -v 'Reading\|number of samples\|nsamples in pop' | gzip -f > ${destination_folder}/min1/reschr${reschr}/chr${MYCHROM}.min1.vcf.gz
done
done
...
cd ~/Dropbox/LDLD/scripts
for myfreq in 1 5;do
myfolder=/mnt/scratch/fabrizio/LDLD/above95/${myannotation}/repl1/min${myfreq}
nohup ./ICLD11amulti.sh ${myfolder} 2 min${myfreq} 1 12 1 23 nspops.txt 1 0.0${myfreq} &
for reschr in 1 1;do
myfolder=/mnt/scratch/fabrizio/LDLD/above95/${myannotation}/repl1/min${myfreq}/reschr${reschr}
nohup ./ICLD11amulti.sh ${myfolder} 2 min${myfreq} 1 12 1 23 nspops.txt 1 0.0${myfreq} &
done
done
...
#zcat /mnt/scratch/fabrizio/LDLD/above95/downloads/20140520.chr${mychr}.strict_mask.fasta.gz | flatten | awk -v OFS='\t' -v MYCHR=${mychr} 'BEGIN{COUNTER=0}{if (substr($1,1,1)!=">"){COUNTER=COUNTER+1;print MYCHR,COUNTER-1,COUNTER,$1}}' | grep '[ZQ]' | gzip -f  > /mnt/scratch/fabrizio/LDLD/above95/downloads/chr${mychr}.ZQ.bed.gz &
#zcat /mnt/scratch/fabrizio/LDLD/above95/downloads/20140520.chr${mychr}.strict_mask.fasta.gz | flatten | awk -v OFS='\t' -v MYCHR=${mychr} 'BEGIN{COUNTER=0}{if (substr($1,1,1)!=">"){COUNTER=COUNTER+1;print MYCHR,COUNTER-1,COUNTER,$1}}' | grep 'N' | gzip -f  > /mnt/scratch/fabrizio/LDLD/above95/downloads/chr${mychr}.N.bed.gz &
zcat /mnt/scratch/fabrizio/LDLD/above95/downloads/20140520.chr${mychr}.strict_mask.fasta.gz | flatten | awk -v OFS='\t' -v MYCHR=${mychr} 'BEGIN{COUNTER=0}{if (substr($1,1,1)!=">"){COUNTER=COUNTER+1;print MYCHR,COUNTER-1,COUNTER,$1}}' | grep '0' | gzip -f  > /mnt/scratch/fabrizio/LDLD/above95/downloads/chr${mychr}.0.bed.gz &
done
for mychr in `seq 1 22`;do
echo $mychr
...
#bedtools merge -i /mnt/scratch/fabrizio/LDLD/above95/downloads/chr${mychr}.H.bed.gz | gzip -f > /mnt/scratch/fabrizio/LDLD/above95/downloads/chr${mychr}.mask.H.bed.gz
#bedtools merge -i /mnt/scratch/fabrizio/LDLD/above95/downloads/chr${mychr}.ZQ.bed.gz | gzip -f > /mnt/scratch/fabrizio/LDLD/above95/downloads/chr${mychr}.mask.ZQ.bed.gz
#bedtools merge -i /mnt/scratch/fabrizio/LDLD/above95/downloads/chr${mychr}.N.bed.gz | gzip -f > /mnt/scratch/fabrizio/LDLD/above95/downloads/chr${mychr}.mask.N.bed.gz
bedtools merge -i /mnt/scratch/fabrizio/LDLD/above95/downloads/chr${mychr}.0.bed.gz | gzip -f > /mnt/scratch/fabrizio/LDLD/above95/downloads/chr${mychr}.mask.0.bed.gz
done

rm /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl1/min1/removed1.bed.overlap.L.bed
rm /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl1/min1/removed1.bed.overlap.H.bed
rm /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl1/min1/removed1.bed.overlap.P.bed
rm /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl1/min1/removed1.bed.overlap.ZQ.bed
rm /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl1/min1/removed1.bed.overlap.0.bed
for mychr in `seq 1 22`;do
echo $mychr
#bedtools intersect -a <( cat /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl1/min1/removed1.bed | sort -Vu -k1,1 -k2,2n | awk -v mychr=$mychr -v OFS='\t' '{if ($1==mychr){print}} ') -b /mnt/scratch/fabrizio/LDLD/above95/downloads/chr${mychr}.mask.L.bed.gz -sorted >> /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl1/min1/removed1.bed.overlap.L.bed
#bedtools intersect -a <( cat /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl1/min1/removed1.bed | sort -Vu -k1,1 -k2,2n | awk -v mychr=$mychr -v OFS='\t' '{if ($1==mychr){print}} ') -b /mnt/scratch/fabrizio/LDLD/above95/downloads/chr${mychr}.mask.H.bed.gz -sorted >> /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl1/min1/removed1.bed.overlap.H.bed
#bedtools intersect -a <( cat /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl1/min1/removed1.bed | sort -Vu -k1,1 -k2,2n | awk -v mychr=$mychr -v OFS='\t' '{if ($1==mychr){print}} ') -b /mnt/scratch/fabrizio/LDLD/above95/downloads/chr${mychr}.mask.P.bed.gz -sorted >> /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl1/min1/removed1.bed.overlap.P.bed
#bedtools intersect -a <( cat /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl1/min1/removed1.bed | sort -Vu -k1,1 -k2,2n | awk -v mychr=$mychr -v OFS='\t' '{if ($1==mychr){print}} ') -b /mnt/scratch/fabrizio/LDLD/above95/downloads/chr${mychr}.mask.ZQ.bed.gz -sorted >> /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl1/min1/removed1.bed.overlap.ZQ.bed
#bedtools intersect -a <( cat /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl1/min1/removed1.bed | sort -Vu -k1,1 -k2,2n | awk -v mychr=$mychr -v OFS='\t' '{if ($1==mychr){print}} ') -b /mnt/scratch/fabrizio/LDLD/above95/downloads/chr${mychr}.mask.N.bed.gz -sorted >> /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl1/min1/removed1.bed.overlap.N.bed
#bedtools intersect -a <( cat /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl1/min1/removed1.bed | sort -Vu -k1,1 -k2,2n | awk -v mychr=$mychr -v OFS='\t' '{if ($1==mychr){print}} ') -b /mnt/scratch/fabrizio/LDLD/above95/downloads/chr${mychr}.mask.0.bed.gz -sorted >> /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl1/min1/removed1.bed.overlap.0.bed
done

mychr=11
bedtools intersect -a /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl1/min1/removed1.bed -b /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl1/min1/removed1.bed -sorted
}

bedtools intersect -a 
bzcat /mnt/sequencedb/CompleteGenomics/Public_Genome_Summary_Analysis/Complete_Public_Genomes_69genomes_all_listvariants.tsv.bz2 | awk -v OFS='\t' '{print $2,$3,$4}'
