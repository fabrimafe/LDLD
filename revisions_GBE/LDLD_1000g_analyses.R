...
bedtools intersect -a ~/Dropbox/LDLD/ms/genomebiology/TableS3.bed -b HRC.r1-1.GRCh37.wgs.mac5.sites.vcf.gz > overlapHRC_exons_min1.bed
bedtools intersect -a ~/Dropbox/LDLD/ms/genomebiology/TableS2.bed -b HRC.r1-1.GRCh37.wgs.mac5.sites.vcf.gz > overlapHRC_exons_min5.bed
bedtools intersect -a ~/Dropbox/LDLD/ms/genomebiology/TableS4.bed -b HRC.r1-1.GRCh37.wgs.mac5.sites.vcf.gz > overlapHRC_intergenic_min5.bed
