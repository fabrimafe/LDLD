...
gcc ICLDmulti13.c -o ICLDmulti.out -lm -lgmp -l popt
cp ICLDmulti13.c 
...
gcc LDLD_filter13.c -o filterbyfreq_multi.out -lgmp -lm -l popt
...
#--------------------------------------------------------
#1) run scan (to tab files)
{
#old runs (with glmm on filtered populations: for which I noticed that very low power, so I get just a few snps)
{
/mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g$ cp merged/min5/logpop_nAB_neg.RData .
/mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g$ cp merged/min5/logpop_nAB_pos20.RData .
cd /mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/merged/min5
nohup ~/Dropbox/LDLD/scripts/nAvsnAB_scan.sh 1 2 /mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/logpop_nAB_pos20.RData logpop_nAB_pos20 0.05 /mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/bad_snps & #bio37
nohup ~/Dropbox/LDLD/scripts/nAvsnAB_scan.sh 3 8 /mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/logpop_nAB_pos20.RData logpop_nAB_pos20 0.05 /mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/bad_snps & #bionc01
nohup ~/Dropbox/LDLD/scripts/nAvsnAB_scan.sh 9 15 /mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/logpop_nAB_pos20.RData logpop_nAB_pos20 0.05 /mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/bad_snps & #bio09
nohup ~/Dropbox/LDLD/scripts/nAvsnAB_scan.sh 16 22 /mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/logpop_nAB_pos20.RData logpop_nAB_pos20 0.05 /mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/bad_snps & #bio74

/mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g$ cp merged/min5/logpop_nAB_neg.RData .
/mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g$ cp merged/min5/logpop_nAB_pos20.RData .
cd /mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/merged/min5
nohup ~/Dropbox/LDLD/scripts/nAvsnAB_scan.sh 1 2 /mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/logpop_nAB_pos20.RData logpop_nAB_pos20 0.01 /mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/bad_snps/min5tomin1 & #bio37
nohup ~/Dropbox/LDLD/scripts/nAvsnAB_scan.sh 3 8 /mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/logpop_nAB_pos20.RData logpop_nAB_pos20 0.01 /mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/bad_snps/min5tomin1 & #bionc01
nohup ~/Dropbox/LDLD/scripts/nAvsnAB_scan.sh 9 15 /mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/logpop_nAB_pos20.RData logpop_nAB_pos20 0.01 /mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/bad_snps/min5tomin1 & #bio09
nohup ~/Dropbox/LDLD/scripts/nAvsnAB_scan.sh 16 22 /mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/logpop_nAB_pos20.RData logpop_nAB_pos20 0.01 /mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/bad_snps/min5tomin1 & #bionc02



nohup ~/Dropbox/LDLD/scripts/nAvsnAB_scan.sh 1 8 /mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/merged/min5/logpop_nAB_pos20.RData logpop_nAB_pos20 0.05 /mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/bad_snps/min5_scaled & #bionc02
...
DESTINATION_FOLDER=/mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/bad_snps_min5

#I put threshold for printing at 0.05. because when lower still only 100 variants.
MYFILERDATA=/mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl2/min5/logpop_nAB_pos.RData
MYTAG=logpop_nAB_pos
DESTINATION_FOLDER=/mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/bad_snps_min5_header_scale
...
~/Dropbox/LDLD/scripts/nAvsnAB_glmm.sh $MYTARGETFILE $MYCHR $MYFILERDATA $MYTAG 0.05 $DESTINATION_FOLDER ~/Dropbox/LDLD/scripts/nAvsnAB_scan_child_subset1000g_header.sh
done


MYFILERDATA=/mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl2/min5/logpop_nAB_pos.RData
MYTAG=logpop_nAB_pos
DESTINATION_FOLDER=/mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/bad_snps_min5_header
mkdir -p $DESTINATION_FOLDER
for MYCHR in `seq 1 22`;do
#MYTARGETFILE=/mnt/sequencedb/1000Genomes/ftp/phase3/20140910/ALL.chr${MYCHR}.phase3_shapeit2_mvncall_integrated_v5.20130502.genotypes.vcf.gz
MYTARGETFILE=/mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl2/min5/chr${MYCHR}.vcf.gz
...
MYFILERDATA=/mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl1/min5/logpop_nAB_pos.RData
MYTAG=logpop_nAB_pos
DESTINATION_FOLDER=/mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl1/min5/bad_snps
mkdir -p $DESTINATION_FOLDER
for MYCHR in `seq 1 22`;do
#MYTARGETFILE=/mnt/sequencedb/1000Genomes/ftp/phase3/20140910/ALL.chr${MYCHR}.phase3_shapeit2_mvncall_integrated_v5.20130502.genotypes.vcf.gz
MYTARGETFILE=/mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl1/min5/chr${MYCHR}.vcf.gz
~/Dropbox/LDLD/scripts/nAvsnAB_glmm.sh $MYTARGETFILE $MYCHR $MYFILERDATA $MYTAG 0.05 $DESTINATION_FOLDER ~/Dropbox/LDLD/scripts/nAvsnAB_scan_child_subset1000g.sh
done
...
MYFILERDATA=/mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl2/min5/logpop_nAB_pos.RData
MYTAG=logpop_nAB_pos
DESTINATION_FOLDER=/mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/bad_snps_min5inmin1
for MYCHR in `seq 1 22`;do
MYTARGETFILE=/mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl2/min5/chr${MYCHR}.vcf.gz
~/Dropbox/LDLD/scripts/nAvsnAB_glmm.sh $MYTARGETFILE $MYCHR $MYFILERDATA $MYTAG 0.01 $DESTINATION_FOLDER ~/Dropbox/LDLD/scripts/nAvsnAB_scan_child_subset1000g.sh
done
}
#--------------------------------------------------------
#newer runs (with glm on filtered populations and glmm on all populations)
{
MYFILERDATA=/mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl2/min5/logpop_nAB_pos.RData
MYTAG=logpop_nAB_pos
DESTINATION_FOLDER=/mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl2/min5/bad_snps_min5_2p
mkdir -p $DESTINATION_FOLDER
for MYCHR in `seq 1 22`;do
MYTARGETFILE=/mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl2/min5/chr${MYCHR}.vcf.gz
~/Dropbox/LDLD/scripts/nAvsnAB_glmm.sh $MYTARGETFILE $MYCHR $MYFILERDATA $MYTAG 0.05 $DESTINATION_FOLDER ~/Dropbox/LDLD/scripts/nAvsnAB_scan_child_subset1000g.sh
...
MYFILERDATA=/mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/merged/min5/logpop_nAB_pos20.RData
MYTAG=logpop_nAB_pos20
DESTINATION_FOLDER=/mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/merged/min5/bad_snps_min5_2p
mkdir -p $DESTINATION_FOLDER
for MYCHR in `seq 12 22`;do
MYTARGETFILE=/mnt/sequencedb/1000Genomes/ftp/phase3/20140910/ALL.chr${MYCHR}.phase3_shapeit2_mvncall_integrated_v5.20130502.genotypes.vcf.gz
~/Dropbox/LDLD/scripts/nAvsnAB_glmm.sh $MYTARGETFILE $MYCHR $MYFILERDATA $MYTAG 0.05 $DESTINATION_FOLDER ~/Dropbox/LDLD/scripts/nAvsnAB_scan_child.sh
done

MYFILERDATA=/mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl2/min5/logpop_nAB_pos.RData
MYTAG=logpop_nAB_pos
DESTINATION_FOLDER=/mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl2/min5/bad_snps_min5_2p_mut
mkdir -p $DESTINATION_FOLDER
for MYCHR in `seq 1 22`;do
MYTARGETFILE=/mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl2/min5/chr${MYCHR}.vcf.gz
~/Dropbox/LDLD/scripts/nAvsnAB_glmm.sh $MYTARGETFILE $MYCHR $MYFILERDATA $MYTAG 0.05 $DESTINATION_FOLDER ~/Dropbox/LDLD/scripts/nAvsnAB_scan_child_subset1000g_mut.sh
done

}
}
#--------------------------------------------------------
#2) scan to fdr (to bed file)
{
#old runs (with glmm on filtered populations: for which I noticed that very low power, so I get just a few snps)
{
myfolder="/mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/bad_snps"
myfolder="/mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/bad_snps/min5tomin1"
myending="_pos20"
myending="_neg"
myending="_pos"

myfolder="/mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/bad_snps_min5_header_scale"
myending="_pos"

cat $myfolder/chr*${myending} | grep FALSE | awk '{print $2,$3,$4}' | sed 's/\"//g' > ${myfolder}/bad_snps${myending}.tab
cat $myfolder/chr*${myending} | grep nlines | awk 'BEGIN{COUNTER=0}{COUNTER=COUNTER+$4}END{print "count","lines",COUNTER}' >> ${myfolder}/bad_snps${myending}.tab

#Rscript to return significant badsnps after fdr
{
myfile=paste0(myfolder,"/bad_snps",myending,".tab")
mybad<-read.table(myfile,stringsAsFactors=FALSE)
names(mybad)<-c("chr","pos","pvalue")
ncomp<-mybad$pvalue[nrow(mybad)]
mybad<-mybad[-length(mybad$pvalue),]
mybad$myfdr<-p.adjust(p=mybad$pvalue, method = "fdr", n =ncomp )
mybadsign<-mybad[mybad$myfdr<0.05,]
mybad<-data.frame(chr=mybadsign$chr,init=as.numeric(mybadsign$pos)-1,end=mybadsign$pos)
write.table(mybad,file=paste0(myfolder,"removed1",myending,".bed"),row.names = FALSE,quote=FALSE,sep='\t',col.names=FALSE)
}

cp /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/bad_snps_min5_header_scale/removed1_pos.bed /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl2/min5/removed1_pos_shell_scale.bed

bedtools sort -i /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/bad_snps_min5_header_scale/removed1_pos.bed > /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl2/min5/removed1_pos_shell_scale.bed

sort -k1,1n -k2,2n /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/bad_snps_min5_header_scale/removed1_pos.bed > /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl2/min5/removed1_pos_shell_scale.bed
}
#newer runs (with glm on filtered populations and glmm on all populations)
{
myfolder="/mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl2/min5/bad_snps_min5_2p"
myending="_pos"

myfolder="/mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/merged/min5/bad_snps_min5_2p"
myending="_pos20"

cat $myfolder/chr*${myending} | grep snp | awk '{print $2,$3,$4,$5}' | sed 's/\"//g' > ${myfolder}/bad_snps${myending}.tab
cat $myfolder/chr*${myending} | grep nlines | awk 'BEGIN{COUNTER=0}{COUNTER=COUNTER+$4}END{print "count","lines",":",COUNTER}' >> ${myfolder}/bad_snps${myending}.tab
...
myfile=paste0(myfolder,"/bad_snps",myending,".tab")
mybad<-read.table(myfile,stringsAsFactors=FALSE)
names(mybad)<-c("chr","pos","pvalue_glmm_full","pvalue_glm_filtered")
ncomp<-mybad[nrow(mybad),ncol(mybad)]
mybad<-mybad[-nrow(mybad),]
mybad$myfdr_glmm_full<-p.adjust(p=mybad$pvalue_glmm_full, method = "fdr", n =ncomp )
mybad$myfdr_glm_filtered<-p.adjust(p=mybad$pvalue_glm_filtered, method = "fdr", n =ncomp )
mybadsign<-mybad[mybad$myfdr_glmm_full<0.05,]
mybadsign_full<-data.frame(chr=mybadsign$chr,init=as.numeric(mybadsign$pos)-1,end=mybadsign$pos)
#toplist<-mybad[order(mybad$myfdr_glm_filtered),][1:1143,] #for myfolder="/mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl2/min5/bad_snps_min5_2p";myending="_pos"
toplist<-mybad[order(mybad$myfdr_glm_filtered),][1:3341,] #for myfolder="/mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/merged/min5/bad_snps_min5_2p"; myending="_pos20"
write.table(mybadsign_full,file=paste0(myfolder,"removed1",myending,".bed"),row.names = FALSE,quote=FALSE,sep='\t',col.names=FALSE)
write.table(toplist,file=paste0(myfolder,"removed1_top",myending,".bed"),row.names = FALSE,quote=FALSE,sep='\t',col.names=FALSE)
}

MYFILE=/mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl2/min5/bad_snps_min5_2premoved1_top_pos.bed
MYFILE=/mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/merged/min5/bad_snps_min5_2premoved1_top_pos20.bed
bedtools sort -i <( cat $MYFILE | awk -v OFS='\t' '{print $1,$2-1,$2,$3,$4,$5,$6}' ) > temp.bed; mv temp.bed $MYFILE

myfolder="/mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/bad_snps"
myending="_pos20"
cat $myfolder/chr*${myending} | grep FALSE | awk '{print $2,$3,$4,$5}' | sed 's/\"//g' > ${myfolder}/bad_snps${myending}.tab
cat $myfolder/chr*${myending} | grep nlines | awk 'BEGIN{COUNTER=0}{COUNTER=COUNTER+$4}END{print "count","lines",":",COUNTER}' >> ${myfolder}/bad_snps${myending}.tab
...
myfile=paste0(myfolder,"/bad_snps",myending,".tab")
mybad<-read.table(myfile,stringsAsFactors=FALSE)
names(mybad)<-c("chr","pos","pvalue_glmm_all","pvalue_glmm_filt","pvalue_glm_filt")
ncomp<-as.numeric(mybad[nrow(mybad),ncol(mybad)])
mybad<-mybad[-nrow(mybad),]
mybad$myfdr_glmm_full<-p.adjust(p=mybad$pvalue_glmm_full, method = "fdr", n =ncomp )
mybad$myfdr_glmm_full<-p.adjust(p=mybad$pvalue_glmm_full, method = "fdr", n =ncomp )
mybad$myfdr_glmm_full<-p.adjust(p=mybad$pvalue_glmm_full, method = "fdr", n =ncomp )
mybadsign<-mybad[mybad$myfdr_glmm_full<0.05,]
write.table(mybadsign[,c(1,2,3,5)],file=paste0(myfolder,"removed1",myending,".bed"),row.names = FALSE,quote=FALSE,sep='\t',col.names=FALSE)
}

MYFILE=/mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/bad_snpsremoved1_pos20.bed
bedtools sort -i <( cat $MYFILE | awk -v OFS='\t' '{print $1,$2-1,$2,$3,$4,$5,$6}' ) > temp.bed; mv temp.bed $MYFILE
}

}
#------------------------------------------------------------------------
#--------------scan bad_snps in shell from 29-09-17------
#------------------------------------------------------------------------
kill $( ps | grep glmm | awk '{print $1}' )
kill $( ps | grep tabix | awk '{print $1}' )
kill $( ps | grep filter | awk '{print $1}' )

rm $DESTINATION_FOLDER/*


wc -l $( ls $DESTINATION_FOLDER/*bed )

{
#preparing tables
echo "#chr  init    end    pval_glm_filt   pval_glmm_all  pval_glmm_filt    fdr_glm_filt   fdr_glmm_all  fdr_glmm_filt" > ~/Dropbox/LDLD/TableS2.bed
echo "#chr  init    end    pval_glm_filt   pval_glmm_all  pval_glmm_filt    fdr_glm_filt   fdr_glmm_all  fdr_glmm_filt" > ~/Dropbox/LDLD/TableS3.bed
cat /mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/merged/min5/bad_snps_glmm/bad_snps_logpop_nAB_pos20_glmm_all.bed >> ~/Dropbox/LDLD/TableS2.bed
cat /mnt/scratch/fabrizio/LDLD/above95/coding.exons.1000g/repl2/min5/bad_snps_glmm/bad_snps_logpop_nAB_pos_glmm_all.bed >> ~/Dropbox/LDLD/TableS3.bed
...
#check min1
{
cd /mnt/scratch/fabrizio/LDLD/above95/intergenic.1000g/merged
tail -1 min1/bad_snps_glmm/*tab
tail -1 min5/bad_snps_glmm/*tab
ls min1/bad_snps_glmm/*pos20  |wc -l
ls min5/bad_snps_glmm/*pos20  |wc -l
cat min5/bad_snps_glmm/*pos20 | grep 'done nlines: 0' | wc -l #77
cat min1/bad_snps_glmm/*pos20 | grep 'done nlines: 0' | wc -l #77
cat min5/bad_snps_glmm/*pos20 | grep done > min5.tab #mydata<-read.table("min5.tab",sep=' ');sum(mydata$V4) #80893069
cat min1/bad_snps_glmm/*pos20 | grep done > min1.tab  #80808800
}
...
#preparing figures
{
#distribution combined p-values
{
#intergenic
...
#barplot seq centers: no-> better inkscape
{
cd ~/Dropbox/dropbox_tablet/programming/plotting/
cp ~/Dropbox/LDLD/ipynb/figs/intergenic.1000g/merged/min1/barplot_relativenAB_pos20.pdf figa.pdf
cp ~/Dropbox/LDLD/ipynb/figs/intergenic.1000g/merged/min5/barplot_relativenAB_pos20.pdf figb.pdf
pdfcrop --margins '0 0 20 0' figa.pdf output.pdf

./add_legend.sh figa.pdf '(a)'
./add_legend.sh figb.pdf '(b)'
pdfjam '(a)_figa.pdf' '(b)_figb.pdf' --nup 1x2 --landscape --outfile output_ab.pdf --
}

cd ~/Dropbox/dropbox_tablet/programming/plotting/
cp ~/Dropbox/LDLD/ipynb/figs/intergenic.1000g/merged/min1/byfreq_summary_bad_snps_logpop_nAB_pos20_glmm_all.bed.tab_sharingCG.pdf figa.pdf
cp ~/Dropbox/LDLD/ipynb/figs/intergenic.1000g/merged/min5/byfreq_summary_bad_snps_logpop_nAB_pos20_glmm_all.bed.tab_sharingCG.pdf figb.pdf
./add_legend.sh figa.pdf '(a)'
./add_legend.sh figb.pdf '(b)'
pdfjam '(a)_figa.pdf' '(b)_figb.pdf' --nup 1x2 --outfile output_ab.pdf --
cp output_ab.pdf ~/Dropbox/LDLD/ipynb/figs/intergenic.1000g/merged/byfreq_summary_bad_snps_logpop_nAB_pos20_sharingCG_min1min5.pdf
cd ~/Dropbox/LDLD/ipynb/figs/intergenic.1000g/merged/
pdf2ps byfreq_summary_bad_snps_logpop_nAB_pos20_sharingCG_min1min5.pdf
ps2eps byfreq_summary_bad_snps_logpop_nAB_pos20_sharingCG_min1min5.ps

cd ~/Dropbox/dropbox_tablet/programming/plotting/
cp ~/Dropbox/LDLD/ipynb/figs/coding.exons.1000g/repl2/min1/byfreq_summary_bad_snps_logpop_nAB_pos_glmm_all.bed.tab_sharingCG.pdf figa.pdf
cp ~/Dropbox/LDLD/ipynb/figs/coding.exons.1000g/repl2/min5/byfreq_summary_bad_snps_logpop_nAB_pos_glmm_all.bed.tab_sharingCG.pdf figb.pdf
./add_legend.sh figa.pdf '(a)'
./add_legend.sh figb.pdf '(b)'
pdfjam '(a)_figa.pdf' '(b)_figb.pdf' --nup 1x2 --outfile output_ab.pdf --
cp output_ab.pdf ~/Dropbox/LDLD/ipynb/figs/coding.exons.1000g/repl2/byfreq_summary_bad_snps_logpop_nAB_pos_sharingCG_min1min5.pdf
cd ~/Dropbox/LDLD/ipynb/figs/coding.exons.1000g/repl2
pdf2ps byfreq_summary_bad_snps_logpop_nAB_pos_sharingCG_min1min5.pdf
ps2eps byfreq_summary_bad_snps_logpop_nAB_pos_sharingCG_min1min5.ps
